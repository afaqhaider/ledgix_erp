                ...
                children: [
                  ...
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(
                        'Date: ${DateFormat('dd MMM yyyy').format(quotation.quotationDate)}',
                        style: pw.TextStyle(font: font),
                      ),
                      pw.Text(
                        'Valid Until: ${DateFormat('dd MMM yyyy').format(quotation.validUntilDate)}',
                        style: pw.TextStyle(font: font),
                      ),
                    ],
                  ),
